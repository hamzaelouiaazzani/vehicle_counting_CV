# Run counting experiment for the tracker strongsort
...
args.tracking_method = "strongsort"
...
path = os.path.join(os.getcwd(), "experiments" , "strongsort" , "strongsort_approach2.json")
