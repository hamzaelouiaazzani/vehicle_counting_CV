# Run counting experiment for the tracker hybridsort
...
args.tracking_method = "hybridsort"
...
path = os.path.join(os.getcwd(), "experiments" , "hybridsort" , "hybridsort_approach2.json")
