...
def main(vid_strides):
    ...
    for vid_stride in vid_strides:
        ...
        path = os.path.join(os.getcwd(), "experiments", "count_track_line_cross_vicinity_method" , f"ocsort_vid_stride_{vid_stride}.json")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run counting with tracking_with_line_crossing_vicinity experiment for specified strides!")
